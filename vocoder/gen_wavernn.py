...
def gen_meltest( model: WaveRNN, batched, target, overlap, save_path ):
	mel = []
	mel.append( np.load("/home/sdevgupta/mine/waveglow/checkpoints_new_waveglow_version_gpu_cloud/outputs/new_mels/mel-5.npy").T )
	mel.append( np.load("/home/sdevgupta/mine/waveglow/checkpoints_new_waveglow_version_gpu_cloud/outputs/new_mels/mel-15.npy").T )
	mel.append( np.load("/home/sdevgupta/mine/waveglow/checkpoints_new_waveglow_version_gpu_cloud/outputs/new_mels/mel-89.npy").T )
