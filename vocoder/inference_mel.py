...
use_cpu = True
sampling_rate = 16000
path = "D:\Voice\wavernn_models\checkpoints\checkpoint_430k_steps.pt"
...
wav = model.generate_from_mel( mel, batched=True, overlap=hp.voc_overlap, target=hp.voc_target, mu_law=True, cpu=use_cpu, apply_preemphasis=False )
