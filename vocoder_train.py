...
# python vocoder_train.py --run_id first_run -m /home/sdevgupta/mine/Real-Time-Voice-Cloning-original/pretrained/vocoder/saved_models/pretrained -g True
...
def main():
    ...
    parser.add_argument("-s", "--save_every", type=int, default=2000, help= \
